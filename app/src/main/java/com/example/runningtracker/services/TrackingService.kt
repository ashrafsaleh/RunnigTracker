...
import com.example.runningtracker.others.Constants.ACTION_SHOW_TRACKING_FRAGMENT
...
import com.example.runningtracker.others.Constants.FASTEST_UPDATE_INTERVAL
import com.example.runningtracker.others.Constants.LOCATION_UPDATE_INTERVAL
import com.example.runningtracker.others.Constants.NOTIFICATION_CHANNEL_ID
import com.example.runningtracker.others.Constants.NOTIFICATION_CHANNEL_NAME
import com.example.runningtracker.others.Constants.NOTIFICATION_ID
import com.example.runningtracker.others.Constants.TIMER_UPDATE_INTERVAL
...
class TrackingService : LifecycleService() {
    ...
    private fun updateLocationTracking(tracking: Boolean) {
        if (tracking) {
            if (TrackingUtility.locationPermission(this)) {
